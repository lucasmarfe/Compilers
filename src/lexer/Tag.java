...
public class Tag {
	...
	public final static int	INDEX = 266; //Será usada na árvore sintática, conforme implementação Aho (2006)
	public final static int LE = 267;
	public final static int MINUS = 268; //Será usada na árvore sintática, conforme implementação Aho (2006)
	...
	public final static int TEMP = 273; //Será usada na árvore sintática, conforme implementação Aho (2006)
